...
[![npm](https://img.shields.io/npm/v/@fcannizzaro/native-window-ipc)](https://www.npmjs.com/package/@fcannizzaro/native-window-ipc)
...
|--------|------|---------|-------------|
| `schemas` | `SchemaMap` | *required* | Schema definitions for each event type |
